...
const RadioOption = ({text,value,stepData}) => {
  ...
  return (
    <div className=' w-[20rem] below-445:w-[15rem] my-4'>
      <div className=' bg-[#e5e1de] border-2 below-321:h-[3rem]  rounded-xl flex h-[4rem] px-4 border-gray-300'>
    ...
    <h1 className=' pl-2 items-center 500 self-center below-321:text-[0.8rem] '>{text}</h1>
      </div>
